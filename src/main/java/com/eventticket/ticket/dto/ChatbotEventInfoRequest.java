...
public class ChatbotEventInfoRequest {

    @NotBlank(message = "Query is required")
    @Schema(description = "The user's question or query about event information", example = "What are the details of the BNK48 concert?")
